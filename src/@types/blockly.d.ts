declare module Blockly {
	...
	type generator_type = (block: Block) => ((string | number)[] | (string | number));
	...
	class Bubble {
		...
		constructor(workspace: WorkspaceSvg, content: SVGElement, shape: Element, anchorXY: {x: number, y: number}, bubbleWidth: number, bubbleHeight: number);
		dispose(): void;
	...
	class FieldDropdown extends Field {
		constructor(menuGenerator: field_options_type | (() => field_options_type), opt_validator?: (val: string | number) => string | number);
	}
	...
	class Workspace {
		...
		registerButtonCallback(name: string, callback: (e: HTMLElement) => void): void;
		registerToolboxCategoryCallback(name: string, callback: (workspace: Blockly.Workspace) => Array<Node>): void;
		render(): void;
	...
	module Extensions {
		...
		function registerMutator(name: string, mixinObj: mixin_object, opt_helperF: (() => void | null), opt_blockList?: string[]): void;
	}
	...
	module Variables {
		function createVariableButtonHandler(workspace: Blockly.Workspace, opt_callback: (name: string | null) => void, opt_type?: string): void;
	}
	...
	// Functions
	function inject(element: HTMLElement | string, opt_options?: blockly_options): Workspace;
